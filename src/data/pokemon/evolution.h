const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
...
#if P_GEN_4_POKEMON == TRUE
    [SPECIES_RHYDON]                = {{EVO_LEVEL, 40, SPECIES_RHYPERIOR}},
#endif
    ...
    [SPECIES_SEADRA]                = {{EVO_LEVEL, 35, SPECIES_KINGDRA}},
...
#if P_GEN_4_POKEMON == TRUE
    [SPECIES_ELECTABUZZ]            = {{EVO_LEVEL, 30, SPECIES_ELECTIVIRE}},
    [SPECIES_MAGMAR]                = {{EVO_LEVEL, 30, SPECIES_MAGMORTAR}},
#endif
    ...
    [SPECIES_DRAGONAIR]             = {{EVO_LEVEL, 40, SPECIES_DRAGONITE}},
...
#if P_GEN_4_POKEMON == TRUE
    [SPECIES_PORYGON2]              = {{EVO_LEVEL, 35, SPECIES_PORYGON_Z}},
#endif
    ...
    [SPECIES_PUPITAR]               = {{EVO_LEVEL, 40, SPECIES_TYRANITAR}},
    ...
    [SPECIES_SHELGON]               = {{EVO_LEVEL, 40, SPECIES_SALAMENCE}},
    ...
    [SPECIES_SOLOSIS]               = {{EVO_LEVEL, 30, SPECIES_DUOSION}},
    ...
    [SPECIES_ELGYEM]                = {{EVO_LEVEL, 40, SPECIES_BEHEEYEM}},
    ...
    [SPECIES_FRAXURE]               = {{EVO_LEVEL, 40, SPECIES_HAXORUS}},
    ...
    [SPECIES_SLIGGOO]               = {{EVO_LEVEL_RAIN, 40, SPECIES_GOODRA}},
    ...
    [SPECIES_SANDYGAST]             = {{EVO_LEVEL, 40, SPECIES_PALOSSAND}},
    [SPECIES_TYPE_NULL]             = {{EVO_FRIENDSHIP, 0, SPECIES_SILVALLY}},
    [SPECIES_JANGMO_O]              = {{EVO_LEVEL, 30, SPECIES_HAKAMO_O}},
    [SPECIES_HAKAMO_O]              = {{EVO_LEVEL, 40, SPECIES_KOMMO_O}},
    [SPECIES_COSMOG]                = {{EVO_LEVEL, 30, SPECIES_COSMOEM}},
    [SPECIES_COSMOEM]               = {{EVO_LEVEL_DAY, 40, SPECIES_SOLGALEO},
    ...
    [SPECIES_HATENNA]               = {{EVO_LEVEL, 30, SPECIES_HATTREM}},
    [SPECIES_HATTREM]               = {{EVO_LEVEL, 40, SPECIES_HATTERENE}},
    [SPECIES_IMPIDIMP]              = {{EVO_LEVEL, 30, SPECIES_MORGREM}},
    ...
    [SPECIES_DRAKLOAK]              = {{EVO_LEVEL, 40, SPECIES_DRAGAPULT}},
    ...
    [SPECIES_GEODUDE_ALOLAN]        = {{EVO_LEVEL, 21, SPECIES_GRAVELER_ALOLAN}},
    [SPECIES_GRAVELER_ALOLAN]       = {{EVO_LEVEL, 32, SPECIES_GOLEM_ALOLAN}},
    ...
    [SPECIES_MR_MIME_GALARIAN]      = {{EVO_LEVEL, 40, SPECIES_MR_RIME}},
    ...
    [SPECIES_YAMASK_GALARIAN]       = {{EVO_SCRIPT_TRIGGER_DMG, 40, SPECIES_RUNERIGUS}},
#else
    [SPECIES_ZIGZAGOON_GALARIAN]    = {{EVO_LEVEL, 20, SPECIES_LINOONE_GALARIAN}},
    [SPECIES_DARUMAKA_GALARIAN]     = {{EVO_ITEM, ITEM_ICE_STONE, SPECIES_DARMANITAN_GALARIAN}},
#endif
