const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_CHARMELEON] = {{EVO_LEVEL, 32, SPECIES_CHARIZARD}},
    [SPECIES_SQUIRTLE]   = {{EVO_LEVEL, 16, SPECIES_WARTORTLE}},
    [SPECIES_WARTORTLE]  = {{EVO_LEVEL, 32, SPECIES_BLASTOISE}},
    ...
    [SPECIES_TENTACOOL]  = {{EVO_LEVEL, 27, SPECIES_TENTACRUEL}},
    [SPECIES_GEODUDE]    = {{EVO_LEVEL, 21, SPECIES_GRAVELER}},
    [SPECIES_GRAVELER]   = {{EVO_LEVEL, 32, SPECIES_GOLEM}},
    [SPECIES_PONYTA]     = {{EVO_LEVEL, 28, SPECIES_RAPIDASH}},
    [SPECIES_SLOWPOKE]   = {{EVO_LEVEL, 28, SPECIES_SLOWBRO},
                            {EVO_ITEM, ITEM_WATER_STONE, SPECIES_SLOWKING}},
    [SPECIES_MAGNEMITE]  = {{EVO_LEVEL, 26, SPECIES_MAGNETON}},
    [SPECIES_DODUO]      = {{EVO_LEVEL, 26, SPECIES_DODRIO}},
    ...
    [SPECIES_CUBONE]     = {{EVO_LEVEL, 26, SPECIES_MAROWAK}},
    ...
    [SPECIES_GOLDEEN]    = {{EVO_LEVEL, 16, SPECIES_SEAKING}},
    ...
    [SPECIES_DRATINI]    = {{EVO_LEVEL, 26, SPECIES_DRAGONAIR}},
    ...
    [SPECIES_SMOOCHUM]   = {{EVO_LEVEL, 19, SPECIES_JYNX}},
    [SPECIES_ELEKID]     = {{EVO_LEVEL, 19, SPECIES_ELECTABUZZ}},
    [SPECIES_MAGBY]      = {{EVO_LEVEL, 19, SPECIES_MAGMAR}},
    ...
    [SPECIES_GROVYLE]    = {{EVO_LEVEL, 32, SPECIES_SCEPTILE}},
    [SPECIES_TORCHIC]    = {{EVO_LEVEL, 16, SPECIES_COMBUSKEN}},
    [SPECIES_COMBUSKEN]  = {{EVO_LEVEL, 32, SPECIES_BLAZIKEN}},
    [SPECIES_MUDKIP]     = {{EVO_LEVEL, 16, SPECIES_MARSHTOMP}},
    [SPECIES_MARSHTOMP]  = {{EVO_LEVEL, 32, SPECIES_SWAMPERT}},
    ...
    [SPECIES_SWABLU]     = {{EVO_LEVEL, 25, SPECIES_ALTARIA}},
    ...
    [SPECIES_LAIRON]     = {{EVO_LEVEL, 35, SPECIES_AGGRON}},
    ...
    [SPECIES_BAGON]      = {{EVO_LEVEL, 26, SPECIES_SHELGON}},
