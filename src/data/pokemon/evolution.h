const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_DUNSPARCE]  = {{EVO_LEVEL, 25, SPECIES_OMASTAR}},
    [SPECIES_FARFETCHD]  = {{EVO_LEVEL, 25, SPECIES_TORKOAL}},
    [SPECIES_TANGELA]    = {{EVO_LEVEL, 25, SPECIES_OMASTAR}},
    [SPECIES_LEDIAN]     = {{EVO_LEVEL, 30, SPECIES_CLOYSTER}},
    [SPECIES_ARIADOS]    = {{EVO_LEVEL, 30, SPECIES_CLOYSTER}},
    [SPECIES_AIPOM]      = {{EVO_LEVEL, 25, SPECIES_OMASTAR}},
    [SPECIES_YANMA]      = {{EVO_LEVEL, 25, SPECIES_OMASTAR}},
    [SPECIES_UNOWN]      = {{EVO_LEVEL, 25, SPECIES_OMASTAR}},
    [SPECIES_SNEASEL]    = {{EVO_LEVEL, 30, SPECIES_CLOYSTER}},
    [SPECIES_DELIBIRD]   = {{EVO_LEVEL, 25, SPECIES_OMASTAR}},
    [SPECIES_SMEARGLE]   = {{EVO_LEVEL, 25, SPECIES_OMASTAR}},
    [SPECIES_BEAUTIFLY]  = {{EVO_LEVEL, 30, SPECIES_CLOYSTER}},
    [SPECIES_DUSTOX]     = {{EVO_LEVEL, 30, SPECIES_CLOYSTER}},
    [SPECIES_NOSEPASS]   = {{EVO_LEVEL, 25, SPECIES_OMASTAR}},
    [SPECIES_SPINDA]     = {{EVO_LEVEL, 25, SPECIES_OMASTAR}},
    [SPECIES_LUVDISC]    = {{EVO_LEVEL, 25, SPECIES_OMASTAR}},
};
