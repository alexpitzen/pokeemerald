const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_GOLBAT]     = {{EVO_LEVEL, 28, SPECIES_CROBAT}},
    [SPECIES_ODDISH]     = {{EVO_LEVEL, 18, SPECIES_GLOOM}},
    [SPECIES_GLOOM]      = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_VILEPLUME},
                            {EVO_ITEM, ITEM_SUN_STONE, SPECIES_BELLOSSOM}},
    [SPECIES_PARAS]      = {{EVO_LEVEL, 20, SPECIES_PARASECT}},
    [SPECIES_VENONAT]    = {{EVO_LEVEL, 20, SPECIES_VENOMOTH}},
    [SPECIES_DIGLETT]    = {{EVO_LEVEL, 21, SPECIES_DUGTRIO}},
    [SPECIES_MEOWTH]     = {{EVO_LEVEL, 20, SPECIES_PERSIAN}},
    [SPECIES_PSYDUCK]    = {{EVO_LEVEL, 25, SPECIES_GOLDUCK}},
    [SPECIES_MANKEY]     = {{EVO_LEVEL, 21, SPECIES_PRIMEAPE}},
    [SPECIES_GROWLITHE]  = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_ARCANINE}},
    [SPECIES_POLIWAG]    = {{EVO_LEVEL, 19, SPECIES_POLIWHIRL}},
    ...
    [SPECIES_TENTACOOL]  = {{EVO_LEVEL, 25, SPECIES_TENTACRUEL}},
    [SPECIES_GEODUDE]    = {{EVO_LEVEL, 20, SPECIES_GRAVELER}},
    [SPECIES_GRAVELER]   = {{EVO_LEVEL, 27, SPECIES_GOLEM}},
    [SPECIES_PONYTA]     = {{EVO_LEVEL, 27, SPECIES_RAPIDASH}},
    [SPECIES_SLOWPOKE]   = {{EVO_LEVEL, 27, SPECIES_SLOWBRO},
                            {EVO_ITEM, ITEM_WATER_STONE, SPECIES_SLOWKING}},
    [SPECIES_MAGNEMITE]  = {{EVO_LEVEL, 26, SPECIES_MAGNETON}},
    [SPECIES_DODUO]      = {{EVO_LEVEL, 25, SPECIES_DODRIO}},
    [SPECIES_SEEL]       = {{EVO_LEVEL, 26, SPECIES_DEWGONG}},
    [SPECIES_GRIMER]     = {{EVO_LEVEL, 26, SPECIES_MUK}},
    [SPECIES_SHELLDER]   = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_CLOYSTER}},
    [SPECIES_GASTLY]     = {{EVO_LEVEL, 21, SPECIES_HAUNTER}},
    [SPECIES_HAUNTER]    = {{EVO_LEVEL, 30, SPECIES_GENGAR}},
    [SPECIES_ONIX]       = {{EVO_LEVEL, 27, SPECIES_STEELIX}},
    [SPECIES_DROWZEE]    = {{EVO_LEVEL, 25, SPECIES_HYPNO}},
    [SPECIES_KRABBY]     = {{EVO_LEVEL, 25, SPECIES_KINGLER}},
    [SPECIES_VOLTORB]    = {{EVO_LEVEL, 26, SPECIES_ELECTRODE}},
    [SPECIES_EXEGGCUTE]  = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR}},
    [SPECIES_CUBONE]     = {{EVO_LEVEL, 20, SPECIES_MAROWAK}},
    [SPECIES_KOFFING]    = {{EVO_LEVEL, 26, SPECIES_WEEZING}},
    [SPECIES_RHYHORN]    = {{EVO_LEVEL, 26, SPECIES_RHYDON}},
    [SPECIES_CHANSEY]    = {{EVO_LEVEL, 32, SPECIES_BLISSEY}},
    ...
    [SPECIES_DRAGONAIR]  = {{EVO_LEVEL, 35, SPECIES_DRAGONITE}},
    ...
    [SPECIES_QUILAVA]    = {{EVO_LEVEL, 32, SPECIES_TYPHLOSION}},
    ...
    [SPECIES_CHINCHOU]   = {{EVO_LEVEL, 25, SPECIES_LANTURN}},
    ...
    [SPECIES_PUPITAR]    = {{EVO_LEVEL, 35, SPECIES_TYRANITAR}},
    ...
    [SPECIES_VIBRAVA]    = {{EVO_LEVEL, 35, SPECIES_FLYGON}},
    [SPECIES_MAKUHITA]   = {{EVO_LEVEL, 24, SPECIES_HARIYAMA}},
    [SPECIES_ELECTRIKE]  = {{EVO_LEVEL, 25, SPECIES_MANECTRIC}},
    [SPECIES_NUMEL]      = {{EVO_LEVEL, 25, SPECIES_CAMERUPT}},
    [SPECIES_SPHEAL]     = {{EVO_LEVEL, 25, SPECIES_SEALEO}},
    [SPECIES_SEALEO]     = {{EVO_LEVEL, 32, SPECIES_WALREIN}},
    [SPECIES_CACNEA]     = {{EVO_LEVEL, 25, SPECIES_CACTURNE}},
    [SPECIES_SNORUNT]    = {{EVO_LEVEL, 28, SPECIES_GLALIE}},
    [SPECIES_AZURILL]    = {{EVO_LEVEL, 14, SPECIES_MARILL}},
    [SPECIES_SPOINK]     = {{EVO_LEVEL, 27, SPECIES_GRUMPIG}},
    [SPECIES_MEDITITE]   = {{EVO_LEVEL, 25, SPECIES_MEDICHAM}},
    [SPECIES_SWABLU]     = {{EVO_LEVEL, 27, SPECIES_ALTARIA}},
    [SPECIES_WYNAUT]     = {{EVO_LEVEL, 15, SPECIES_WOBBUFFET}},
    [SPECIES_DUSKULL]    = {{EVO_LEVEL, 25, SPECIES_DUSCLOPS}},
    [SPECIES_SLAKOTH]    = {{EVO_LEVEL, 18, SPECIES_VIGOROTH}},
    [SPECIES_VIGOROTH]   = {{EVO_LEVEL, 32, SPECIES_SLAKING}},
    [SPECIES_GULPIN]     = {{EVO_LEVEL, 25, SPECIES_SWALOT}},
    [SPECIES_WHISMUR]    = {{EVO_LEVEL, 17, SPECIES_LOUDRED}},
    [SPECIES_LOUDRED]    = {{EVO_LEVEL, 27, SPECIES_EXPLOUD}},
    [SPECIES_CLAMPERL]   = {{EVO_LEVEL, 25, SPECIES_HUNTAIL},
    ...
    [SPECIES_LAIRON]     = {{EVO_LEVEL, 32, SPECIES_AGGRON}},
    ...
    [SPECIES_SHELGON]    = {{EVO_LEVEL, 35, SPECIES_SALAMENCE}},
    [SPECIES_BELDUM]     = {{EVO_LEVEL, 20, SPECIES_METANG}},
    [SPECIES_METANG]     = {{EVO_LEVEL, 35, SPECIES_METAGROSS}},
};
